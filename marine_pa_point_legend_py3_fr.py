...
rule_based_style(layer, renderer, 'Statut international - Terrestre', ' "DESIG_TYPE" = \'International\' AND \"MARINE\" = 0 ', '#90c04e', '#cc775d')
rule_based_style(layer, renderer, 'Statut international - Côtière', ' "DESIG_TYPE" = \'International\' AND \"MARINE\" = 2 ', '#679b95', '#cc775d')
rule_based_style(layer, renderer, 'Statut international - Marine', ' "DESIG_TYPE" = \'International\' AND \"MARINE\" = 1 ', '#70b6d1', '#cc775d')

rule_based_style(layer, renderer, 'Proposition - Terrestre', ' \"MARINE\" = 0 AND "STATUS" = \'Proposed\' ', '#90c04e', '#787878')
rule_based_style(layer, renderer, 'Proposition - Côtière', ' \"MARINE\" = 2 AND "STATUS" = \'Proposed\' ', '#90c04e', '#787878')
rule_based_style(layer, renderer, 'Proposition - Marine', ' \"MARINE\" = 1 AND "STATUS" = \'Proposed\' ', '#90c04e', '#787878')
