...
rule_based_style(layer, renderer, 'International designation', ' "DESIG_TYPE" = \'International\' ', '#cc775d')
...
#    'line_width':'0.26'})
#renderer.symbols(QgsRenderContext())[0].changeSymbolLayer(0, linePatternLayer)
rule_based_style(layer, renderer, 'Proposed', ' "STATUS" = \'Proposed\' ', '#787878')
